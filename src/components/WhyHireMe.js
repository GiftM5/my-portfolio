  ...
  const reasons = [
    {
      ...
      icon: "🚀",
      description: "Final-year Software Engineering student with proven expertise in Python and Java, backed by comprehensive training and multiple industry certifications.",
      details: [
    ...
    },
    {
      ...
      icon: "💻",
      description: "Equipped with current industry skills including cloud security, AI awareness, and full-stack development capabilities.",
      details: [
    ...
    },
    {
      ...
      icon: "👥",
      description: "Currently mentoring bootcamp students and coordinating tech events, demonstrating leadership potential and communication skills.",
      details: [
    ...
    },
    {
      ...
      icon: "🧠",
      description: "Demonstrated ability to tackle complex challenges through multiple certifications and real-world project implementations.",
      details: [
    ...
    },
    {
      ...
      icon: "⚡",
      description: "Equipped with modern development practices and tools that companies need, from version control to cloud deployment.",
      details: [
    ...
    },
    {
      ...
      icon: "🌟",
      description: "Passionate learner who balances technical excellence with personal interests, bringing both analytical thinking and creative problem-solving to teams.",
      details: [
        ...
        <Row>
          <Col size={12}>
            <div className="why-hire-me-bx">
              ...
              <p>Here's what makes me the ideal junior developer for your team:</p>
                  ...
                  <Col lg={4} md={6} className="mb-4" key={reason.id}>
                    ...
                    >
                      <Card.Body>
                        ...
                        <div className={`reason-details ${activeCard === reason.id ? 'show' : ''}`}>
                          <ul>
              ...
              <div className="hire-me-cta">
                ...
                <p>I bring technical skills, leadership experience, and a growth mindset that will add immediate value to your development team.</p>
                <div className="cta-buttons">
                  <a href="https://github.com/GiftM5" target="_blank" rel="noopener noreferrer" className="cta-button primary">
                    <ArrowRightCircle size={20} />
                    View My Code
                  </a>
                  <a href="https://www.linkedin.com/in/mpho-mofokeng-956b6b328/" target="_blank" rel="noopener noreferrer" className="cta-button secondary">
                    <ArrowRightCircle size={20} />
                    Connect on LinkedIn
                  </a>
                </div>
